...
test("can print a type", () => {
  const type = t
    .Object(
      ...
      t
        .prop("tags", t.Array(t.str).options({ title: "Tags" }))
        .options({ title: "Always use tags" }),
      ...
      t.prop(
        "objectProperty",
        t.Object(
          t.prop("id", t.str.options({ ascii: true, min: 3, max: 128 })),
        ),
      ),
      t.prop(
        "unionProperty",
        t.Or(t.str, t.num, t.nil.options({ description: "" })),
      ),
      t.propOpt(
        "enumAsConst",
        t.Or(
        ...
        t.Object(
          t.prop(
            ...
            t
              ...
              .options({ title: "Always use replace" }),
          ),
          t.prop("path", t.str),
          t.prop("value", t.any),
        ),
          ...
          .Binary(
            t
              .Tuple(
                t
                  .Const(7 as const)
                  .options({ description: "7 is the magic number" }),
                t.str,
                t.any,
              )
