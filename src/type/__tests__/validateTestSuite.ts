...
export const validateTestSuite = (
  validate: (type: Type, value: unknown) => void,
) => {
  ...
  describe("const", () => {
    test("exact value of primitives", () => {
      ...
      validate(num, 123);
      expect(() => validate(num, 1234)).toThrowErrorMatchingInlineSnapshot(
        `"CONST"`,
      );
      validate(str, "asdf");
      expect(() => validate(str, "asdf_")).toThrowErrorMatchingInlineSnapshot(
        `"CONST"`,
      );
      validate(truthy, true);
      expect(() => validate(truthy, 1)).toThrowErrorMatchingInlineSnapshot(
        `"CONST"`,
      );
      expect(() => validate(truthy, false)).toThrowErrorMatchingInlineSnapshot(
        `"CONST"`,
      );
      validate(nil, null);
      expect(() => validate(nil, undefined)).toThrowErrorMatchingInlineSnapshot(
        `"CONST"`,
      );
      expect(() => validate(nil, false)).toThrowErrorMatchingInlineSnapshot(
        `"CONST"`,
      );
    });
    ...
    test("exact value of primitives", () => {
      ...
      validate(arr, [1, 2, 3]);
      expect(() =>
        validate(arr, [1, 2, 3, 4]),
      ).toThrowErrorMatchingInlineSnapshot(`"CONST"`);
      validate(obj, { foo: "bar" });
      expect(() =>
        validate(obj, { foo: "bar", baz: "bar" }),
      ).toThrowErrorMatchingInlineSnapshot(`"CONST"`);
    });
  });
  ...
  describe("undefined", () => {
    test('validates online "undefined" value', () => {
      ...
      expect(() => validate(type, false)).toThrowErrorMatchingInlineSnapshot(
        `"CONST"`,
      );
      expect(() => validate(type, null)).toThrowErrorMatchingInlineSnapshot(
        `"CONST"`,
      );
      expect(() => validate(type, 123)).toThrowErrorMatchingInlineSnapshot(
        `"CONST"`,
      );
    });
  });
  ...
  describe("boolean", () => {
    test('validates "boolean" value', () => {
      ...
      expect(() =>
        validate(type, undefined),
      ).toThrowErrorMatchingInlineSnapshot(`"BOOL"`);
      expect(() => validate(type, 123)).toThrowErrorMatchingInlineSnapshot(
        `"BOOL"`,
      );
    });
  ...
  describe("number", () => {
    test('validates simple "number" value', () => {
      ...
      expect(() =>
        validate(type, undefined),
      ).toThrowErrorMatchingInlineSnapshot(`"NUM"`);
      expect(() => validate(type, "asdf")).toThrowErrorMatchingInlineSnapshot(
        `"NUM"`,
      );
    });
    ...
    describe("validates formats", () => {
      describe("i", () => {
        test("cannot be float", () => {
          ...
          validate(type, 456);
          validate(type, 0);
          expect(() => validate(type, 3.14)).toThrowErrorMatchingInlineSnapshot(
            `"INT"`,
          );
        });
        ...
        test("cannot be Infinity", () => {
          const type = t.Number({ format: "i" });
          expect(() =>
            validate(type, Number.POSITIVE_INFINITY),
          ).toThrowErrorMatchingInlineSnapshot(`"INT"`);
          expect(() =>
            validate(type, Number.NEGATIVE_INFINITY),
          ).toThrowErrorMatchingInlineSnapshot(`"INT"`);
        });
      });
      ...
      describe("u", () => {
        ...
        test("cannot be negative", () => {
          const type = t.Number({ format: "u" });
          expect(() => validate(type, -1)).toThrowErrorMatchingInlineSnapshot(
            `"UINT"`,
          );
        });
      });
      ...
      describe("i8", () => {
        test("should be within bounds", () => {
          ...
          expect(() => validate(type, 128)).toThrowErrorMatchingInlineSnapshot(
            `"INT"`,
          );
          expect(() => validate(type, -129)).toThrowErrorMatchingInlineSnapshot(
            `"INT"`,
          );
        });
        ...
        test("cannot be float", () => {
          const type = t.Number({ format: "i8" });
          validate(type, 123);
          expect(() => validate(type, 1.1)).toThrowErrorMatchingInlineSnapshot(
            `"INT"`,
          );
        });
      });
      ...
      describe("i32", () => {
        test("should be within bounds", () => {
          ...
          expect(() =>
            validate(type, 0xffffffaa),
          ).toThrowErrorMatchingInlineSnapshot(`"INT"`);
          expect(() =>
            validate(type, -0xffffffab),
          ).toThrowErrorMatchingInlineSnapshot(`"INT"`);
        });
      ...
      describe("u8", () => {
        test("should be within bounds", () => {
          ...
          expect(() => validate(type, 256)).toThrowErrorMatchingInlineSnapshot(
            `"UINT"`,
          );
          expect(() => validate(type, -1)).toThrowErrorMatchingInlineSnapshot(
            `"UINT"`,
      ...
      describe("u16", () => {
        test("should be within bounds", () => {
          ...
          expect(() =>
            validate(type, 0xffff + 1),
          ).toThrowErrorMatchingInlineSnapshot(`"UINT"`);
          expect(() => validate(type, -1)).toThrowErrorMatchingInlineSnapshot(
            `"UINT"`,
          );
        });
    ...
    describe("bounds", () => {
      test("gt", () => {
        ...
        validate(type, 11);
        expect(() => validate(type, 10)).toThrowErrorMatchingInlineSnapshot(
          `"GT"`,
        );
      });
      ...
      test("gte", () => {
        ...
        validate(type, 10);
        expect(() => validate(type, 9)).toThrowErrorMatchingInlineSnapshot(
          `"GTE"`,
        );
      });
      ...
      test("lte", () => {
        ...
        validate(type, 10);
        expect(() => validate(type, 11)).toThrowErrorMatchingInlineSnapshot(
          `"LTE"`,
        );
      });
      ...
      test("gt and lt", () => {
        ...
        expect(() => validate(type, 20)).toThrowErrorMatchingInlineSnapshot(
          `"LT"`,
        );
      });
    });
  ...
  describe("string", () => {
    ...
    describe("size bounds", () => {
      test("respects min and max", () => {
        ...
        validate(type, "foo");
        expect(() => validate(type, "f")).toThrowErrorMatchingInlineSnapshot(
          `"STR_LEN"`,
        );
        expect(() =>
          validate(type, "foooo"),
        ).toThrowErrorMatchingInlineSnapshot(`"STR_LEN"`);
      });
    ...
    describe("custom validators", () => {
      test("throws if custom validator fails", () => {
        ...
        validate(type, "!");
        expect(() => validate(type, "foo")).toThrowErrorMatchingInlineSnapshot(
          `"VALIDATION"`,
        );
      });
    });
  ...
  describe("binary", () => {
    ...
    test("throws on Uint16Array", () => {
      const type = t.bin;
      expect(() =>
        validate(type, new Uint16Array()),
      ).toThrowErrorMatchingInlineSnapshot(`"BIN"`);
    });
  });
  ...
  describe("array", () => {
    ...
    describe("size bounds", () => {
      test("respects min and max", () => {
        ...
        ).toThrowErrorMatchingInlineSnapshot(`"ARR_LEN"`);
      });
  ...
  describe("object", () => {
    ...
    test("checks for required fields", () => {
      ...
      expect(() =>
        validate(type, { foo: "bar" }),
      ).toThrowErrorMatchingInlineSnapshot(`"STR"`);
    });
  });
  ...
  describe("ref", () => {
    test("validates after recursively resolving", () => {
      ...
      validate(ref, 1);
      expect(() => validate(ref, "1")).toThrowErrorMatchingInlineSnapshot(
        `"REF"`,
      );
    });
  });
  ...
  describe("or", () => {
    test('validates "one-of"', () => {
      ...
      validate(or, 1);
      validate(or, "a");
      expect(() => validate(or, null)).toThrowErrorMatchingInlineSnapshot(
        `"OR"`,
      );
    });
  });
  ...
  describe("custom validators", () => {
    ...
    test("const", () => {
      ...
      expect(() => type.validate(2)).toThrowErrorMatchingInlineSnapshot(
        `"VALIDATION"`,
      );
    });
    ...
    test("bool", () => {
      ...
      expect(() => type.validate(true)).toThrowErrorMatchingInlineSnapshot(
        `"VALIDATION"`,
      );
    });
    ...
    test("str", () => {
      ...
      expect(() => type.validate("xyz")).toThrowErrorMatchingInlineSnapshot(
        `"VALIDATION"`,
      );
    });
    ...
    test("arr", () => {
      ...
      expect(() =>
        type.validate([1, 2, 3, 4]),
      ).toThrowErrorMatchingInlineSnapshot(`"VALIDATION"`);
    });

    test("tup", () => {
      const type = t
        .Tuple(t.num)
        .options({ validator: ["noop", "first-element-1"] });
      type.validate([1]);
      expect(() => type.validate(123)).toThrowErrorMatchingInlineSnapshot(
        `"TUP"`,
      );
    ...
    test("obj", () => {
      const type = t
        .Object(t.prop("foo", t.str))
        .options({ validator: ["noop", "foo.is.bar", "noop"] });
      type.validate({ foo: "bar" });
      expect(() => type.validate([])).toThrowErrorMatchingInlineSnapshot(
        `"OBJ"`,
      );
      expect(() =>
        type.validate({ foo: "baz" }),
      ).toThrowErrorMatchingInlineSnapshot(`"VALIDATION"`);
    });
  });
};
