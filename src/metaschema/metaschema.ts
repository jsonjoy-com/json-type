...
export const module: ModuleSchema = {
  ...
  keys: [
    ...
    {kind: 'key', key: 'SchemaExample', value: {
      kind: 'obj',
      extends: ['Display'],
      keys: [
    ...
    {kind: 'key', key: 'SchemaBase', value: {
      ...
      keys: [
        ...
        {kind: 'key', key: 'examples', optional: true, value: {kind: 'arr', type: {kind: 'ref', ref: 'SchemaExample'}}},
        {kind: 'key', key: 'deprecated', optional: true, value: {
          kind: 'obj',
          keys: [
            {kind: 'key', key: 'info', optional: true, value: {kind: 'str'}},
          ],
        }},
        {kind: 'key', key: 'metadata', optional: true, value: {kind: 'map', value: {kind: 'any'}}},
      ],
    } as ObjSchema},
    {kind: 'key', key: 'AnySchema', value: {
      kind: 'obj',
      extends: ['SchemaBase'],
      keys: [
    ...
    {kind: 'key', key: 'BoolSchema', value: {
      kind: 'obj',
      extends: ['SchemaBase'],
      keys: [
        {kind: 'key', key: 'kind', value: {kind: 'con', value: 'bool'} as ConSchema<'bool'>},
      ],
    } as ObjSchema},
    {kind: 'key', key: 'NumSchema', value: {
      kind: 'obj',
      extends: ['SchemaBase'],
      keys: [
    ...
    {kind: 'key', key: 'AliasSchema', value: {
      kind: 'obj',
      extends: ['KeySchema'],
      keys: [
        {kind: 'key', key: 'pub', optional: true, value: {kind: 'bool'}},
      ],
    } as ObjSchema},
    {kind: 'key', key: 'ModuleSchema', value: {
      kind: 'obj',
      keys: [
