...
test("emit an interface with all type kinds", () => {
  ...
  const alias = system.alias(
    ...
    t.Object(
      ...
      t.prop(
        "obj",
        t.Object(t.prop("reg", t.str), t.prop("arr", t.Array(t.str))),
      ),
  ...
  const alias = system.alias(
    ...
    t.Object(
      t.prop(
        ...
        t.Tuple(
          t.str,
          t.Object(t.prop("id", t.str), t.prop("title", t.bool)),
          t.num,
        ),
      ),
    ),
...
test("can export whole router and aliases", () => {
  ...
  system.alias(
    "Document",
    t
      .Object(t.prop("id", t.str), t.prop("title", t.str))
      .options({ title: "The document" }),
  );
  const router = new TypeRouter({ system, routes: {} }).extend(() => ({
    callMe: t.Function(t.str, t.num),
    "block.subscribe": t.Function$(
